...
import { simulationToCsv } from "@/modules/simulations/exports";
...
export async function GET(
  ...
  return new NextResponse(simulationToCsv(simulation), {
    headers: {
      "content-disposition": `attachment; filename="cronograma-${id}.csv"`,
